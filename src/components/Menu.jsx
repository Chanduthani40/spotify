      ...
      <ul className="menu-ul">
        {menuList.map((eachObj, index) => (
          <div className="menu-ul-li">
            {index > 1 && isLogin === false ? (
              <Popup
                trigger={
                  <li
                    style={{
                      opacity:
                        (eachObj.isOpacity || eachObj.isMouseOver) && "0.9",
                    }}
                    onClick={() => {
                      handleSearch(eachObj.display);
                      updateMenu(eachObj.display);
                    }}
                    onMouseOver={() => {
                      handleMouseOver(eachObj.display);
                    }}
                    onMouseOut={() => {
                      handleMouseOut(eachObj.display);
                    }}
                  >
                    <i className={eachObj.class} style={{ width: "55%" }}></i>
                    <h5>{eachObj.display}</h5>
                  </li>
                }
              ...
              >
                <div className="popup-container">
                  ...
                  <p>
                    Login to see saved songs,podcasts,artists and playlists in
                    your library{" "}
                  </p>
              ...
              <li
                style={{
                  opacity: (eachObj.isOpacity || eachObj.isMouseOver) && "0.9",
                }}
                onClick={() => {
                  handleSearch(eachObj.display);
                  updateMenu(eachObj.display);
